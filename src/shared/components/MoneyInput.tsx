    ...
    <div>
      ...
      <div className="mt-1 relative">
        ...
        <input
          ...
          type="text"
          inputMode="numeric"
          className={`block w-full appearance-none rounded-md border bg-white pl-9 pr-3 py-2 text-gray-900 placeholder:text-gray-400 placeholder-gray-400 shadow-sm focus:outline-none sm:text-sm dark:bg-gray-700 dark:text-white dark:placeholder:text-gray-500 ${borderClass} ${disabled ? "opacity-50 cursor-not-allowed bg-gray-50 dark:bg-gray-800" : ""}`}
          value={displayValue}
