...
export default function OutputForm({ formMethods, onSave, onCancel, isLoading }: IOutputFormProps) {
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="md:col-span-2 flex items-start space-x-4">
            ...
            <div className="text-sm">
                <label htmlFor="isRecurring" className="font-medium text-gray-900 dark:text-gray-200">
                    Despesa Fixa?
                </label>
                <p className="text-gray-500 dark:text-gray-400">Marque se esta for uma despesa recorrente (ex: aluguel, salários).</p>
            </div>
        </div>
