...
export default function CategoryForm({ formMethods, onSave, onCancel, isLoading }: ICategoryFormProps) {
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="md:col-span-2 flex items-start space-x-4">
            ...
            <div className="text-sm">
                <label htmlFor="allowsSingleEvent" className="font-medium text-gray-900 dark:text-gray-200">
                    Permite Evento Avulso?
                </label>
                <p className="text-gray-500 dark:text-gray-400">Marque se esta categoria pode ser usada em eventos avulsos.</p>
            </div>
        </div>
         <div className="md:col-span-2">
